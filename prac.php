...
$questions = array(
    ...
    <input type="radio" name="q2" value="D" />Ans 4<br>`,
    `
    <h4>Question 3</h4>
    ...
    <input type="radio" name="q3" value="D" />Ans 4<br>`,
    `
    <h4>Question 4</h4>
    ...
    <input type="radio" name="q4" value="D" />Ans 4<br>`,
    `
    <h4>Question 5</h4>
    ...
    <input type="radio" name="q5" value="D" />Ans 4<br>`,
    `
    <h4>Question 6</h4>
    ...
    <input type="radio" name="q6" value="D" />Ans 4<br>`,
    `
    <h4>Question 7</h4>
    ...
    <input type="radio" name="q7" value="D" />Ans 4<br>`,
    `
    <h4>Question 8</h4>
    ...
    <input type="radio" name="q8" value="D" />Ans 4<br>`,
    `
    <h4>Question 9</h4>
    ...
    <input type="radio" name="q9" value="D" />Ans 4<br>`,
    `
    <h4>Question 10</h4>
    ...
    <input type="radio" name="q10" value="D" />Ans 4<br>`,
    `
    <h4>Question 11</h4>
    ...
    <input type="radio" name="q11" value="D" />Ans 4<br>`,
    `
    <h4>Question 12</h4>
    ...
    <input type="radio" name="q12" value="D" />Ans 4<br>`,
    `
    <h4>Question 13</h4>
    ...
    <input type="radio" name="q13" value="D" />Ans 4<br>`,
    `
    <h4>Question 14</h4>
    ...
    <input type="radio" name="q14" value="D" />Ans 4<br>`,
    `
    <h4>Question 15</h4>
    ...
    <input type="radio" name="q15" value="D" />Ans 4<br>`,
    `
    <h4>Question 16</h4>
    ...
    <input type="radio" name="q16" value="D" />Ans 4<br>`,
    `
    <h4>Question 17</h4>
    ...
    <input type="radio" name="q17" value="D" />Ans 4<br>`,
    `
    <h4>Question 18</h4>
    ...
    <input type="radio" name="q18" value="D" />Ans 4<br>`,
    `
    <h4>Question 19</h4>
    ...
    <input type="radio" name="q19" value="D" />Ans 4<br>`,
    `
    <h4>Question 20</h4>
    ...
    <input type="radio" name="q20" value="D" />Ans 4<br>`,
);
?>
